...
type IBObjectManager interface {
	...
	CreateARecord(netView string, dnsView string, name string, cidr string, ipAddr string, ipAddrStruct IPV4Addr, ttl uint32, useTTL bool, comment string, ea EA) (*RecordA, error)
